    ...
    public class AccountValidator : AbstractValidator<Account>
    {
        public AccountValidator()
        {
            ...
            RuleFor(account => account.Password).NotEmpty().WithState(account => "PasswordBoxPassword")
                .MaximumLength(80).WithState(account => "PasswordBoxPassword")
        ...
        public AccountValidator(Account accountCurrent)
        {
            ...
            RuleFor(account => account.Password).NotEmpty().MaximumLength(80).MinimumLength(8).Equal(accountCurrent.Password).WithState(account => "PasswordBoxPassword");
        }
