namespace DataPersistenceLayer.Migrations
{
    ...
    public partial class SolvingUpdateError : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("dbo.Projects", "DaysHours", c => c.String(nullable: false, maxLength: 100));
            AlterColumn("dbo.Practicioners", "IdGroup", c => c.Int());
            ...
            AddForeignKey("dbo.Practicioners", "IdGroup", "dbo.Groups", "IdGroup");
        }
        ...
        public override void Down()
        {
            ...
            DropColumn("dbo.Projects", "DaysHours");
